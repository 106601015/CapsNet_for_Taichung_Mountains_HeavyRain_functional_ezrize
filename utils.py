...
def get_batch_data(dataset, batch_size, num_threads):
    if dataset == 'mnist':
        trX, trY, num_tr_batch = load_mnist(batch_size, is_training=True)  #, valX, valY, num_val_batch
    elif dataset == 'fashion-mnist':
        trX, trY, num_tr_batch = load_fashion_mnist(batch_size, is_training=True)
    elif dataset == 'myself':
        trX, trY, num_tr_batch = load_myself(batch_size, is_training=True)
